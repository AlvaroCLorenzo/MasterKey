...
import Controllers.CreateNewCreditCardViewController;
 ...
 * @autor: Alvaro
 */
public class CreateNewCreditCardView extends JDialog {
    ...
    private Image imageCreateNew;

    private CreditCardsView vistaPadre;

    private CreateNewCreditCardViewController controller;

    public CreateNewCreditCardView(CreditCardsView vistaPadre) {
        super(vistaPadre, true); //Para crear cuadro modal que bloquee la ventana anterior hasta que esta se cierre.
        this.vistaPadre = vistaPadre;
        initObjects();
        objectsDesing();
        joinObjects();
        this.controller = new CreateNewCreditCardViewController(this);
    ...
    private void initObjects() {
        ...
        this.title = new RoundedLabel(Texts.CREATE_NEW_CREDIT_CARD_TITLE, 790, 50, 25, Colors.PRIMARY_GREEN, Colors.BLACK);
    ...
    private void objectsDesing() {
        //FRAME
        this.setTitle(Texts.CREATE_NEW_CREDIT_CARD_TITLE);
        this.setLayout(null);
        this.getContentPane().setBackground(Colors.DARK_GRAY_BACKGROUND);
        this.setSize(930, 930);
        this.setResizable(false);
        this.setIconImage(this.imageCreateNew); //Añadimos un icono
        ...
        this.buttonCreateNew.setBounds(255, 720, 350, 80);
    }
    ...
    public void paint(Graphics grphcs) {
        ...
        g2d.drawImage(this.imageCreateNew, 650, 790, 64, 64, this);
    }
    ...
    public void showNewCreditCardCreated() {
        JOptionPane.showMessageDialog(this.vistaPadre, Texts.NEW_CREDIT_CARD_CREATED, Texts.SUCCESSFUL_CREATION_TITLE, JOptionPane.INFORMATION_MESSAGE, new ImageIcon(this.imageCreateNew));
    }
