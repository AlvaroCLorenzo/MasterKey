...
import Controllers.SocialNetworksViewController;
 ...
 * @autor: Alvaro
 */
public class SocialNetworksView extends JDialog {

    //Objects needed
    private RoundedPanel panel;
    private RoundedLabel title;
    private List socialNetworkList;
    private RoundedButton buttonOpen, buttonCreateNew;

    private Image imageSocialNetwork, imageOpen70, imageCreateNew;

    private SocialNetworksViewController controller;

    public SocialNetworksView(YourAcountsView vistaPadre, String humanPassword) {
        super(vistaPadre, true); //Para crear cuadro modal que bloquee la ventana anterior hasta que esta se cierre.
        initObjects();
        objectsDesing();
        joinObjects();
        this.controller = new SocialNetworksViewController(this, humanPassword);
    ...
    private void initObjects() {
        ...
        this.title = new RoundedLabel(Texts.SOCIAL_NETWORKS_TITLE, 600, 50, 25, Colors.PRIMARY_GREEN, Colors.BLACK);
        this.socialNetworkList = new List();
        ...
        try {
            this.imageSocialNetwork = ImageIO.read(new File(Texts.IMAGE_SOCIALNETWORK_64));
    ...
    private void objectsDesing() {
        //FRAME
        this.setTitle(Texts.SOCIAL_NETWORKS_TITLE);
        this.setLayout(null);
        this.getContentPane().setBackground(Colors.DARK_GRAY_BACKGROUND);
        this.setSize(710, 930);
        this.setResizable(false);
        this.setIconImage(this.imageSocialNetwork); //Añadimos un icono
        ...
        //LIST
        this.socialNetworkList.setBounds(30, 200, 590, 300);
        this.socialNetworkList.setFont(Fonts.MY_FONT5);
        //OPEN BUTTON
    ...
    private void joinObjects() {
        ...
        this.panel.add(this.socialNetworkList);
    ...
    public void paint(Graphics grphcs) {
        ...
        g2d.drawImage(this.imageSocialNetwork, 323, 170, 64, 64, this);
    ...
    //Metodo utilizado para refrescar la informacion de la lista de social networks.
    public void refreshList(String humanPrivateKey) {
        this.controller.getSocialNetWorks(humanPrivateKey);
        this.controller.listSocialNetworks();
    }
    ...
    //Error no social networks
    public void showErrorNoSocialNetworks() {
        JOptionPane.showMessageDialog(this, Texts.ERROR_NO_SOCIAL_NETWORKS, Texts.ERROR_TITLE, JOptionPane.ERROR_MESSAGE);
    }

    public List getSocialNetworkList() {
