...
import Controllers.CryptoWalletsViewController;
 ...
 * @autor: Alvaro
 */
public class CryptoWalletsView extends JDialog {

    //Objects needed
    private RoundedPanel panel;
    private RoundedLabel title;
    private RoundedButton buttonOpen, buttonCreateNew;
    private List cryptoWalletsList;

    private Image imageCryptoWallet, imageOpen70, imageCreateNew;

    private CryptoWalletsViewController controller;

    public CryptoWalletsView(YourAcountsView vistaPadre, String humanPassword) {
        super(vistaPadre, true); //Para crear cuadro modal que bloquee la ventana anterior hasta que esta se cierre.
        initObjects();
        objectsDesing();
        joinObjects();
        this.controller = new CryptoWalletsViewController(this, humanPassword);
    ...
    private void initObjects() {
        ...
        this.title = new RoundedLabel(Texts.CRYPTO_WALLETS_BUTTON, 600, 50, 25, Colors.PRIMARY_GREEN, Colors.BLACK);
        this.cryptoWalletsList = new List();
        this.buttonOpen = new RoundedButton(Texts.OPEN_BUTTON, 350, 80, 25, Colors.SECONDARY_ORANGE, Colors.BLACK);
        this.buttonCreateNew = new RoundedButton(Texts.CREATE_NEW_BUTTON, 350, 80, 25, Colors.SECONDARY_GREEN, Colors.BLACK);
        try {
    ...
    private void objectsDesing() {
        //FRAME
        this.setTitle(Texts.CRYPTO_WALLETS_BUTTON);
        this.setLayout(null);
        this.getContentPane().setBackground(Colors.DARK_GRAY_BACKGROUND);
        this.setSize(710, 930);
        this.setResizable(false);
        this.setIconImage(this.imageCryptoWallet); //Añadimos un icono
        ...
        //LIST
        this.cryptoWalletsList.setBounds(30, 200, 590, 300);
        this.cryptoWalletsList.setFont(Fonts.MY_FONT5);
        //OPEN BUTTON
    ...
    private void joinObjects() {
        ...
        this.panel.add(this.cryptoWalletsList);
    ...
    public void paint(Graphics grphcs) {
        ...
        g2d.drawImage(this.imageCryptoWallet, 320, 170, 70, 70, this);
    ...
    //Metodo utilizado para refrescar la informacion de la lista de crypto wallets.
    public void refreshList(String humanPrivateKey) {
        this.controller.getCryptoWallets(humanPrivateKey);
        this.controller.listCryptoWallets();
    }
    ...
    //Error no crypto wallets
    public void showErrorNoCryptoWallets() {
        JOptionPane.showMessageDialog(this, Texts.ERROR_NO_CRYPTO_WALLETS, Texts.ERROR_TITLE, JOptionPane.ERROR_MESSAGE);
    }

    public List getCryptoWalletsList() {
        return cryptoWalletsList;
    }
