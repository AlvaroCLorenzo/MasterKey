...
import Controllers.CreateNewCryptoWalletViewController;
 ...
 * @autor: Alvaro
 */
public class CreateNewCryptoWalletView extends JDialog {
    ...
    private CreateNewCryptoWalletViewController controller;

    public CreateNewCryptoWalletView(CryptoWalletsView vistaPadre) {
        super(vistaPadre, true); //Para crear cuadro modal que bloquee la ventana anterior hasta que esta se cierre.
        this.vistaPadre = vistaPadre;
        initObjects();
        objectsDesing();
        joinObjects();
        this.controller = new CreateNewCryptoWalletViewController(this);
    ...
    private void initObjects() {
        ...
        this.title = new RoundedLabel(Texts.CREATE_NEW_CRYPTO_WALLET_TITLE, 790, 50, 25, Colors.PRIMARY_GREEN, Colors.BLACK);
    ...
    private void objectsDesing() {
        //FRAME
        this.setTitle(Texts.CREATE_NEW_CRYPTO_WALLET_TITLE);
        this.setLayout(null);
        this.getContentPane().setBackground(Colors.DARK_GRAY_BACKGROUND);
        this.setSize(930, 780);
        this.setResizable(false);
        this.setIconImage(this.imageCreateNew64); //Añadimos un icono
    ...
    //New Crypto Wallet Created Succesful
    //Se ve en la vista padre.
    public void showNewCryptoWalletCreated() {
        JOptionPane.showMessageDialog(this.vistaPadre, Texts.NEW_CRYPTO_WALLET_CREATED, Texts.SUCCESSFUL_CREATION_TITLE, JOptionPane.INFORMATION_MESSAGE, new ImageIcon(this.imageCreateNew64));
    }
